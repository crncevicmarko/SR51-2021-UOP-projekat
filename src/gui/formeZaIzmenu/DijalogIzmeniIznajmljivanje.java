...
public class DijalogIzmeniIznajmljivanje extends JFrame{
	...
	public DijalogIzmeniIznajmljivanje (Biblioteka biblioteka,IzdavanjeKnjige izdavanje) {
	...
	private void initActions() {
		btnCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				DijalogIzmeniIznajmljivanje.this.dispose();
				DijalogIzmeniIznajmljivanje.this.setVisible(false);
			}
		});
...
//			cmbxZaposleni.addItem(zap.getKorisnickoIme());
//		}
		...
		if(izdavanje != null) {
			...
			cmbxZaposleni.setSelectedItem(izdavanje.getZaposleni());
			cmbxClan.setSelectedItem(izdavanje.getClan());
			cmbxPrimerak.setSelectedItem(izdavanje.getPrimerak());
		}
